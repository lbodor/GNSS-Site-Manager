...
export class ToolbarComponent implements OnInit {
  ...
  constructor(private http: Http, private serviceWorkerService: ServiceWorkerService, public globalService: GlobalService,
  ...
  clearCache() {
    console.log('CLEAR');
    this.http.get('/clearCache').map((response: Response) => {
        console.log('CLEARED');
    });
  }
  // clearCache = (): void => {
